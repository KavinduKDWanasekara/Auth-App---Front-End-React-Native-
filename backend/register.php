<?php 
	...
	$result= $mysqli->query("SELECT * FROM studentmaster where email='$email'");
		...
		{		
		   $add = $mysqli->query("insert into studentmaster (name,email,password) values('$name','$email','$password')");
